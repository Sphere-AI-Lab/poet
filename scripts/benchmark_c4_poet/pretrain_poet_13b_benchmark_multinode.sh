...
# bash pretrain_poet_13b_benchmark_multinode.sh 0 0 1 1 512
# bash pretrain_poet_13b_benchmark_multinode.sh 1 0 1 1 512
# bash pretrain_poet_13b_benchmark_multinode.sh 2 0 1 1 512
# bash pretrain_poet_13b_benchmark_multinode.sh 3 0 1 1 512
# bash pretrain_poet_13b_benchmark_multinode.sh 4 0 1 1 512
# bash pretrain_poet_13b_benchmark_multinode.sh 5 0 1 1 512
# bash pretrain_poet_13b_benchmark_multinode.sh 6 0 1 1 512
# bash pretrain_poet_13b_benchmark_multinode.sh 7 0 1 1 512